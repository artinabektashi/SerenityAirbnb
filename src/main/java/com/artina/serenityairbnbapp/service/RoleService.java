...
import com.artina.serenityairbnbapp.exception.RoleAlreadyExistsException;
import com.artina.serenityairbnbapp.model.Role;
import com.artina.serenityairbnbapp.model.User;
import com.artina.serenityairbnbapp.repository.RoleRepository;
   ...
   private final UserRepository userRepository;
    ...
    public User assignRoleToUser(Long userId, Long roleId) {
        ...
        if(user.isPresent() && user.get().getRoles().contains(role.get())){
            throw new UsernameNotFoundException(user.get().getFirstName()+" is already assigned to this role"+role.get().getName());
        }
        if(role.isPresent()){
